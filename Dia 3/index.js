...
// MarksModel.aggregate([{$match :{subject_name: "Maquetacion"}},
...
// MarksModel.aggregate([{$match: {date: {'$lt' : new Date('2022,06,11')}}},
...
// MarksModel.aggregate([{$match: {date: {'$lt' : new Date("2022,08,11")}}},
